/*
 * PD Stepper Webpage + MQTT Read-Only Dashboard Final 7.0
 * ------------------------------------------------------
 * Eigenschaften:
...
<title>PD Stepper ESP32 7.0</title>
<style>
body{
...
const unsigned long telemetrySendIntervalMs  = 25;
...
void loop() {
  ...
  if (!apModeActive && mqttClient.connected()) {
    ...
    if (now - lastTelemetrySendMs >= telemetrySendIntervalMs) {
